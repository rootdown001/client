...
const Input = ({
  ...
  <input
    ...
    className=" my-2 w-full rounded-sm p-2 outline-none bg-transparent text-white border-none text-sm glass-white"
  ></input>
);
    ...
    <div className=" flex w-full justify-center items-center">
      <div className=" flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        ...
        <div className=" flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
          ...
          {/* transaction form */}
          <div className=" p-5 sm:w-96 w-full flex flex-col justify-start items-center glass-blue">
            {/* inputs */}
            <Input
